...
test_expect_success 'Git version string X.Y.Z' '
	echo "Git version string X.Y.Z" >verstring &&
	cat verstring >/home/philipoakley/repos/git/t/Versionstring.txt &&
	test_line_count =  1 verstring &&
	egrep -q "^git version [0-9]+\.[0-9]+\.[0-9]+.*" verstring
'

test_expect_success 'git version string 1.2.3' '
	echo "git version 1.2.3" >verstring &&
	test_line_count =  1 verstring &&
	egrep -q "^git version [0-9]+\.[0-9]+\.[0-9]+.*" verstring
'

test_expect_success 'git version string 1.2.3 ABC' '
	echo "git version 1.2.3 ABC" >verstring &&
	test_line_count =  1 verstring &&
	len=$(wc -c verstring | sed "s/[^0-9]//g") &&
	test $len -lt  80 &&
	egrep -q "^git version [0-9]+\.[0-9]+\.[0-9]+.*" verstring
'
test_expect_success 'git version string 1.2.3 ABC LONGGGGG' '
	echo "git version 1.2.3 ABC23456789012345678901234567890123456789012345678901234567890" >verstring &&
	test_line_count =  1 verstring &&
	len=$(wc -c verstring | sed "s/[^0-9]//g") &&
	test $len -lt  80 &&
	egrep -q "^git version [0-9]+\.[0-9]+\.[0-9]+.*" verstring
'
test_expect_success 'git version string 1' '
	echo "git version 1.2.3" >verstring &&
	test_line_count =  1 verstring &&
	egrep -q "^git version [0-9]" verstring
'
...
test_expect_success 'git version ' '
	echo "git version 1.2.3" >verstring &&
	test_line_count =  1 verstring &&
	egrep -q "^git version " verstring
'
